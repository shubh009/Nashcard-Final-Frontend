...
const fpassword = () => {
  ...
  const sendLink = async () => {
    ...
    if (emailError) {
      ...
      setForgotForm(false);
      let result = await fetch(`${process.env.REACT_APP_API_URL}/emailsend`, {
        method: "post",
            ...
            {forgotForm ? (
              <div className="login-left login-Outer">
                ...
                <p className="text-secondary">
                  ...
                  <br></br> so we can send a link to reset password
                </p>
                  ...
                  <form>
                    ...
                    <div className="form-group text-center">
                      <Link to={"/signup"} className="text-black ">
                        Not Yet a Nashcards Customer? <b>Create Account</b>
                      </Link>
                    </div>
                  </form>
                </div>
              ...
              <div className="login-left login-Outer">
                ...
                <p className="text-secondary">
                  Lost Your Password? Please Create New Password Here.
                </p>
                <div className="login-form">
                  <form>
                    <div className="form-group">
                      ...
                      ></input>
                      {otpValidation ? (
                        <label className="text-danger">Invalid OTP</label>
                      ) : (
                        ""
                      )}
                    </div>
