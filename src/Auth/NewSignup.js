    ...
    if (isvalid) {
      if (
        ...
        if (result) {
          ...
          alert(
            "Thanks, your account has been successfully created at Nashcard!!! Now You can login & enjoy grading services "
          );
          navigate("/login");
        }
      } else {
          ...
          <div className="col-lg-6 noleftrightpadding">
            <div className="login-left signup-Outer">
              ...
              <p className="text-secondary">
                Hey, it's look like you dont have Nashcard account. <br></br>{" "}
                ...
                <form>
                  ...
                  <div className="form-group">
                    ...
                    {contactValidationError ? (
                      <label className="text-danger">Invalid Phone NO</label>
                    ) : (
                      ""
                    )}
                  </div>
                  ...
                  <div className="form-group text-center ">
                    <Link to={"/login"} className="text-primary">
                      Already a Nashcards Customer? <b>Login Now</b>
                    </Link>
                  </div>
                </form>
              </div>
