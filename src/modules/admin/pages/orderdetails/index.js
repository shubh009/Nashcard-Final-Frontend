                                ...
                                </tr>
                                {
                                   orderGrades.map(glist=>(
                                    ...
                                    <tr className={glist._id}>
                                      ...
                                      <td className="bg-success text-center text-text-decoration-none"><Link to="#" className="text-white">Get Images</Link></td>
                                      <td>{gradeListPsa}</td>
                 ...
                 <div className="col-lg-6">
                   <div className="form-group">
                    ...
                    <option name="select">Select Service Level</option>
                    {
                         ...
                         name="select">{svlist.servicelevel}</option>
                        ))                      
                    }
                   ...
                   <div className="form-group">
                    <label>PSA Up-charge Occurred (add below)</label>
                       ...
                       <ul className="list-unstyled list-inline">
                          ...
                          <li className="list-inline-item">
                            <input id="r2" type="radio" name="radio" value="2"></input>
