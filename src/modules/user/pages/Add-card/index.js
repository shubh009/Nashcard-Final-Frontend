...
const index = () => {
  ...
  const FinalOrder = async (e) => {
    if (ref.current.checked) {
      alert(
        "Your order has been sucessfully placed. You will get an confirmation email shortly. Thank You"
      );

      const uemail = "conser.in3@gmail.com";
      let result = await fetch(
        `${process.env.REACT_APP_API_URL}/sendorderemail`,
        {
          method: "post",
  ...
  const updateorderfinal = async (orderid) => {
    let result = await fetch(
      `${process.env.REACT_APP_API_URL}/updateorderfinal/` + orderid,
      {
        method: "PATCH",
        body: JSON.stringify({
          userid: userid,
        ...
        <div className="row">
          ...
          <div className="col-lg-10 noleftrightpadding">
              ...
              <div className="row orer-details">
                    ...
                    <div className="col-lg-4">
                      <div className="form-group">
                        ...
                        <input
                          type="text"
                          className="form-control"
                          value={totalcardcount * pricepercard}
                          disabled
                        ></input>
                      </div>
                    </div>
                ...
                <div className="col-lg-3">
                  <div className="theme-highlight-div text-center">
                    ...
                    <div className="form-group listt">
                      <span className="heading-level-4">
                        DV Less Then $2378
                      </span>
                    </div>
                  </div>
              ...
              <div className="row noleftrightpadding">
                <div className="col-lg-4  d-block">
                  ...
                  <div className="form-group">
                    ...
                    <p className="light-text">
                      Please enter the total amount of insurance you would like
                      (i.e. 1,500 and NOT $6)
                    </p>
                  </div>
                </div>
                <div className="col-lg-4">
                  <div className="form-group alert-box">
                    ...
                    ></input>
                    <p className="light-text">
                      add your cell phone to be informed with text message
                      updates
                    </p>
                  </div>
                </div>
                <div className="col-lg-4 norightpadding">
                  <div className="theme-highlight-div text-center">
                    <div className="form-group listt">
                      <span className="heading-level-4">
                        Return Shipping Once Graded
                      </span>
                    </div>
                    <div className="form-group listt">
                      <span className="heading-level-4">
                        $6 per $500 Package Insurance
                      </span>
                    </div>
                    <div className="form-group listt">
                      <span className="heading-level-4">
                        {" "}
                        $1.5k insurance will add $18 to your order
                      </span>
                    </div>
                    <div className="form-group listt">
                      <span className="heading-level-4">
                        $500 insurance will add $6 to your order
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="row">
                ...
                <div className="col-lg-4">
                  <button
                    className="submitbtn d-block mt-4 mt-2"
                    type="submit"
                    onClick={() => updateorderfinal(orderid)}
                  >
                    Add Your Insurance & Alert
                  </button>
                </div>
              </div>
            </div>
            <div className="Dashboardsec box-shadow">
              ...
              <div className="row mt-3">
                <p className="light-text">
                  Along with email updates, add your cell phone to be informed
                  with text message updates. We'll update you for status
                  updates, when your grades pop and when it's time for final
                  payment. Not interested, just leave it blank and we won't
                  bother you!
                </p>
                <p className="light-text">
                  Once grades pop, we provide a link via email to view your
                  grades. Payment is due at that time and expected at time of
                  invoice days. Failure to pay within 30 days will result in a
                  collection attempt process as outlined on our privacy and
                  terms policy pages. In addition, I agree to the Price Change
                  policy also located on our terms policy page. By checking the
                  Yes, I Agree box and submitting this order, you agree to abide
                  by the terms as linked.
                </p>
              </div>
              <div className="row">
                ...
                <div className="col-lg-6">
                  <div className="mb-3 mt-3">
                    <label className="heading-level-4">
                      Please note our shipping address has changed as of 7/7/22:
                    </label>
                    ...
                    <ul className="list-unstyled">
                      ...
                      <li className="mt-2">
                        <p>
                          ...
                          ></input>
                          <label for="vehicle1" className="ml-10">
                            {" "}
                            Yes, I Agree
                          </label>
                        </p>
