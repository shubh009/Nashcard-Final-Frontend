...
const index = () => {
  ...
  const handlegrcompanychange = async (evt) => {
    ...
    let response = await fetch(
      `${process.env.REACT_APP_API_URL}/getservicelevel/` + grcmpname,
      {
        method: "get",
        headers: {
  ...
  const CreateGradingorder = async (event) => {
    ...
    if (serviceLevelvalue !== "" && cardsCount !== "" && selectedRb !== "") {
      ...
      let result = await fetch(`${process.env.REACT_APP_API_URL}/order`, {
        method: "post",
        body: JSON.stringify({
          userid: userid,
          orderid: neworderid,
                    ...
                    <div className="form-data">
                      <form>
                        ...
                        <div className="form-group">
                          ...
                          ></input>
                          <p className="mt-2">
                            This is just an estimate for now. your total cards
                            will be calculated once your cards are logged.
                          </p>
                          {ErrorCountTextbox ? (
                            <label className="text-danger">No iS Invalid</label>
                          ) : (
                            ""
                          )}
                        </div>
                        ...
                        <div className="form-group">
                          <button
                            type="submit"
                            onClick={CreateGradingorder}
                            className="submitbtn"
                          >
                            Create Order & Log Cards
                          </button>
                        </div>
                      </form>
                    </div>
                ...
                <div className="col-lg-6">
                  <div className="right-content">
                    <div className="disable-form">
                      <label className="heading-level-3">
                        Please review the year and DV Values:{" "}
                      </label>
                    ...
                    <div className="highlightbox">
                      <div className="row">
                        <div className="col-lg-7">
                          ...
                          <p>
                            Need cards reviewed? What a professional opinion?
                          </p>
                        </div>
                        <div className="col-lg-5 float-end">
                          <Link to="#" className="highlightbtn">
                            {" "}
                            Create Review
                          </Link>
                        </div>
